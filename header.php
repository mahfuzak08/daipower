			...
			<div class="container-fluid clearfix">
				<div class="logo-header mostion logo-dark">
					<a href="index.php">
						...
						<div>
							...
							<h1 class="logo-brand-title">DAI POWER</h1>
				...
				<div class="header-nav navbar-collapse collapse justify-content-center" id="navbarNavDropdown">
					<div class="logo-header">
						<a href="index.php">
							<img src="images/logo.png" alt="">
							<h1>DAI POWER SOURCE PTE. LTD.</h1>
						</a>
					</div>
					<ul class="nav navbar-nav navbar navbar-left">
						...
						<li class="sub-menu-down"><a href="#">Products</a>
							<ul class="sub-menu">
								<li><a href="#">Intelligent Transportation Systems (ITS)</a></li>
						...
						<li class="sub-menu-down"><a href="#">Projects</a>
							<ul class="sub-menu">
								<li><a href="#">ITS</a></li>
								<li><a href="#">EPC Projects</a></li>
